...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/21 09:13:58 by momari            #+#    #+#             */
/*   Updated: 2024/02/22 11:32:20 by momari           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	animate_le(t_data *data)
{
	...
	{
		if (data->map_2[data->p_pla_y][data->p_pla_x - 1] == 'I')
			ft_handle_error(-2, "You lose :(", data);
		else if (data->map_2[data->p_pla_y][data->p_pla_x - 1] == 'E')
		{
			if (data->n_coll2 == 0)
			{
				data->moves_c++;
...
void	animate_do(t_data *data)
{
	...
	{
		if (data->map_2[data->p_pla_y + 1][data->p_pla_x] == 'I')
			ft_handle_error(-2, "You lose :(", data);
		else if (data->map_2[data->p_pla_y + 1][data->p_pla_x] == 'E')
		{
			if (data->n_coll2 == 0)
			{
				data->moves_c++;
